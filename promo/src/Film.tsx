...
const Outro = () => {
  ...
  return <AbsoluteFill>
    ...
    <div style={{position:'absolute',left:84,bottom:95,color:'#8591a5',fontSize:15,lineHeight:1.6}}>Multi-model agreement is not a guarantee of correctness.<br/>Music: “Cipher” — Kevin MacLeod · incompetech.com · CC BY 4.0<br/>creativecommons.org/licenses/by/4.0/ · Excerpt edited and faded.</div>
